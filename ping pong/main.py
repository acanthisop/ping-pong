...
def update():
    ...
    paddle_B.x = paddle_B.x + held_keys['b'] * time.dt

    paddle_B.x = paddle_B.x - held_keys['m'] * time.dt
...
paddle_A = Entity(parent=table, color=color.random_color(), model='cube', scale=(0.20, 0.03, 0.05),
...
ball = Entity(parent=table, model='sphere', color=color.red, scale=0.09,
